    ...
    >
      ...
      <DialogContent>
        <Typography
          ...
          sx={{ mb: 3 }}
        >
          Controla qué eventos del calendario deben excluirse del cálculo de
          horas laborales. Los eventos excluidos no contarán como tiempo
